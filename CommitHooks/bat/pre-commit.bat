...
%PERL% F:\Repositories\ETCM.next\CommitHooks\ValidateCommitMessage\ValidateCommitMessage.pl %TXN% %REPOS%
IF ERRORLEVEL 1 exit 1

REM verify user is checking into the right place
%PYTHON% F:\Repositories\ETCM.next\CommitHooks\BugBranch\bugbranchdriver.py %REPOS% %TXN%
IF ERRORLEVEL 1 exit 1
